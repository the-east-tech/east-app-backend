...
public class StorageAdminService {
    ...
    private static void assertStorageAdmin(AuthenticatedUser principal) {
        if (principal.systemRole() != SystemRole.ADMIN) {
            throw forbidden();
        }
    }
    ...
    private static ApiException forbidden() {
        return new ApiException(
                ...
                "Storage management is restricted to the platform administrator."
        );
    }
